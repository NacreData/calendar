...
<template>
    <div class="desc">
        <h1 v-badge> :ripple: Contributing Events</h1>
            ...
            <p>Welcome! Contributing events is easy and accessible. By contributing events
            you help to ensure that the events you or your org host are accessible to the
            wider community outside of Instagram, you're able to make your events look
            exactly how you want, and ensure that events posted are as up-to-date and
            accurate as possible. This project's maintainers hope you'll join them in
            trying to help foster a greater and more integrated community in the Triangle
            area of NC.</p>

            <p>There are a couple different ways to contribute events to the calendar, but
            the main way that'll be gone over in this guide will be by using Google
            Calendar. If you have your events hosted via another service or software
            package online feel free to email this project's maintainers to discuss
            integrating those to minimize your work required.</p>
            
        <h2>One-time Quick-add or Direct-add events:</h2>

            <p>While the prefered method is to set up your own calendar and have this
            software read and combine those events into this calendar, that may not be
            necessary or accessible to everyone. You can also <a
            href="mailto:triangleradicalevents@gmail.com">email us details about your
            event (triangleradicalevents@gmail.com)</a> - please give us several days do
